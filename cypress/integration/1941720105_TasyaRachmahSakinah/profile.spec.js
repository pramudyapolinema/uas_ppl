describe('Profile', () => {
    ...
    cy.get('#password').type('tasya300601')
    ...
    // cy.get('#changePasswordFormNotification').should('have.been.calledOnce', 'Your changes have been saved.')
    })

    // it('Profile Scenario - Invalid OldPassword', () => {
    // cy.visit('http://jip.polinema.ac.id/ojs3/index.php/jip/login')
    // cy.get('#username').type('tasya')
    // cy.get('#password').type('tasya300604')
    // cy.get('#login > fieldset > div.buttons > button').click()
    ...
    // cy.contains('Password').click()
    // cy.get('input[name=oldPassword]').type('tasya300601')
    // cy.get('input[name=password]').type('tasya300605')
    // cy.get('input[name=password2]').type('tasya300605')
    // cy.get('.submitFormButton').click()
    // })
    ...
    // cy.contains('View Profile').click()
    // cy.contains('Password').click()
    // cy.get('input[name=oldPassword]').type('tasya300604')
